...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r " + Fore.MAGENTA + "[*]" + Fore.BLUE + " Attack status => " + str(
...
##############################################################################################
def get_info_l7():
    stdout.write("\x1b[38;2;255;20;147m • " + Fore.WHITE + "EMAIL INSTAGRAM     " + Fore.LIGHTCYAN_EX + ": " + Fore.LIGHTGREEN_EX)
    target = input()
    stdout.write("\x1b[38;2;255;20;147m • " + Fore.WHITE + "USERNAME            " + Fore.LIGHTCYAN_EX + ": " + Fore.LIGHTGREEN_EX)
    thread = input()
    stdout.write("\x1b[38;2;255;20;147m • " + Fore.WHITE + "PASSWORD            " + Fore.LIGHTCYAN_EX + ": " + Fore.LIGHTGREEN_EX)
    t = input()
...
quotes = [
  # Author
  'SH1R0DOS @shiroku made in indonesia',
  f'Welcome! Owner, {pcpy.get_user()}.',
  ...
  while True:
    ...
    if 'credits' in cmdl:
      ...
      printf(Center.XCenter(Colorate.Vertical(Colors.red_to_purple, f'''
        ...
        {random.choice(wms)}
                                 ╦══╩══════════════0══════════════════╩══╦
DDOS MADE IN BY INDONESIA

   _,met$$$$$gg.                 root-shiroko@cs-613399860363-default
      ,g$$$$$$$$$$$$$$$P.        OS: Windows 11 Home Single Language
    ,g$$P            Y$$..       Kernel: 64-bit operating system, x64-based processor
   ,$$P'              `$$$.      Uptime : - -
   ,$$P       ,ggs.     `$$b:    Packages: 721
   d$$'     ,$P"'   .    $$$     Shell: bash 5.1.4
   $$P      d$'     ,    $$P     Disk: 4,00 GB (3,84 GB usable)
   $$:      $$.   -    ,d$$'     Intel(R) Core(TM) i3-10110U CPU @ 2.10GHz   2.59 GHz
   $$\;      Y$b._   _,d$P'      RAM: 1476MiB / 7957MiB
   Y$$.    `.`"Y$$$$P"'         
   `$$b      "-.__              
    `Y$$                        
     `Y$$.                      
